...
@{N='FreeSpace(GB)'; E={[Math]::Round(($_.FreeSpace)/1GB,2)}} | Format-Table -Autosize 
...
Get-NetIPConfiguration | Select-Object -Property InterfaceAlias,InterfaceDescription,NetProfile.Name,IPv4Address | Format-Table
