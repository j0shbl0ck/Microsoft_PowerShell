...
$SentToScope = "OutsideOrganization"
$ApplyHtmlDisclaimer = $true
...
$ApplyDisclaimerFallbackAction = "Wrap"

# Create the transport rule
New-TransportRule -Name $Name -Priority $Priority -Enabled $Enabled -FromScope $FromScope -SentToScope $SentToScope -ApplyHtmlDisclaimer $ApplyHtmlDisclaimer -ApplyHtmlDisclaimerText $ApplyHtmlDisclaimerText -ApplyDisclaimerFallbackAction $ApplyDisclaimerFallbackAction
