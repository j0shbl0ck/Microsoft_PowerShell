...
Write-Host "Outlook Calendar Permission Levels and Access Roles" -ForegroundColor Yellow
Write-Host "=======================================================" -ForegroundColor Yellow
...
Write-Verbose = "Allowing $seconduser the role of $role to $mainuser calendar..." -ForegroundColor Cyan
Write-Verbose = "Complete!" -ForegroundColor Cyan
Write-Host = ""
